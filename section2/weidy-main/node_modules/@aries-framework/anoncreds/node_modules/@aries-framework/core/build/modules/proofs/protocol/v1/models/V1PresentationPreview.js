...
const PredicateType_1 = require("../../../formats/indy/models/PredicateType");
...
V1PresentationPreview.type = (0, messageType_1.parseMessageType)('https://didcomm.org/present-proof/1.0/presentation-preview');
__decorate([
    (0, class_transformer_1.Expose)({ name: '@type' }),
    (0, messageType_1.IsValidMessageType)(V1PresentationPreview.type),
