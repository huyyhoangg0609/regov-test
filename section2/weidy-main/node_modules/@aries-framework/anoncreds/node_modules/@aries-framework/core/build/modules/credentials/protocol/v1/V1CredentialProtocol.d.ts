...
import type { AcceptCredentialOptions, AcceptCredentialOfferOptions, AcceptCredentialProposalOptions, AcceptCredentialRequestOptions, CreateCredentialOfferOptions, CreateCredentialProblemReportOptions, CreateCredentialProposalOptions, CredentialProtocolMsgReturnType, NegotiateCredentialOfferOptions, NegotiateCredentialProposalOptions } from '../CredentialProtocolOptions';
...
export declare class V1CredentialProtocol extends BaseCredentialProtocol<[IndyCredentialFormatServiceLike]> implements CredentialProtocol<[IndyCredentialFormatServiceLike]> {
     ...
     *
     */
    createProposal(agentContext: AgentContext, { connectionRecord, credentialFormats, comment, autoAcceptCredential, }: CreateCredentialProposalOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<AgentMessage>>;
    /**
     ...
     * @returns Object containing proposal message and associated credential record
     */
    acceptProposal(agentContext: AgentContext, { credentialRecord, credentialFormats, comment, autoAcceptCredential, }: AcceptCredentialProposalOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<V1OfferCredentialMessage>>;
    /**
     ...
     *
     */
    negotiateProposal(agentContext: AgentContext, { credentialFormats, credentialRecord, comment, autoAcceptCredential, }: NegotiateCredentialProposalOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<V1OfferCredentialMessage>>;
    /**
     ...
     *
     */
    createOffer(agentContext: AgentContext, { credentialFormats, autoAcceptCredential, comment, connectionRecord, }: CreateCredentialOfferOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<V1OfferCredentialMessage>>;
    /**
     ...
     *
     */
    acceptOffer(agentContext: AgentContext, { credentialRecord, credentialFormats, comment, autoAcceptCredential, }: AcceptCredentialOfferOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<V1RequestCredentialMessage>>;
    /**
     ...
     *
     */
    negotiateOffer(agentContext: AgentContext, { credentialFormats, credentialRecord, autoAcceptCredential, comment, }: NegotiateCredentialOfferOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<AgentMessage>>;
    /**
     ...
     *
     */
    acceptRequest(agentContext: AgentContext, { credentialRecord, credentialFormats, comment, autoAcceptCredential, }: AcceptCredentialRequestOptions<[IndyCredentialFormatServiceLike]>): Promise<CredentialProtocolMsgReturnType<V1IssueCredentialMessage>>;
    /**
    ...
    getFormatData(agentContext: AgentContext, credentialExchangeId: string): Promise<GetCredentialFormatDataReturn<ExtractCredentialFormats<[IndyCredentialFormatServiceLike]>>>;
    private rfc0592ProposalFromV1ProposeMessage;
    private assertOnlyIndyFormat;
    getFormatServiceForRecordType(credentialRecordType: string): IndyCredentialFormatServiceLike;
}
export {};
