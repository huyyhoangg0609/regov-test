 ...
 */
export declare function checkValidEncoding(raw: unknown, encoded: string): boolean;
/**
...
export declare function assertAttributesMatch(schema: AnonCredsSchema, attributes: CredentialPreviewAttribute[]): void;
/**
 ...
 * */
export declare function createAndLinkAttachmentsToPreview(attachments: LinkedAttachment[], previewAttributes: CredentialPreviewAttribute[]): CredentialPreviewAttribute[];
