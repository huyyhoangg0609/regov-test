...
exports.createAndLinkAttachmentsToPreview = exports.assertAttributesMatch = exports.encode = exports.checkValidEncoding = exports.assertCredentialValuesMatch = exports.checkCredentialValuesMatch = exports.convertAttributesToCredentialValues = void 0;
 ...
 */
function checkValidEncoding(raw, encoded) {
    return encoded === encode(raw);
}
exports.checkValidEncoding = checkValidEncoding;
/**
...
function encode(value) {
    ...
    return new bn_js_1.default(core_1.Hasher.hash(Buffer.from(value), 'sha2-256')).toString();
}
...
function createAndLinkAttachmentsToPreview(attachments, previewAttributes) {
    ...
    attachments.forEach((linkedAttachment) => {
        if (credentialPreviewAttributeNames.includes(linkedAttachment.attributeName)) {
            ...
            const credentialPreviewAttribute = new core_1.CredentialPreviewAttribute({
