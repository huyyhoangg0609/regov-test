...
let AnonCredsApi = class AnonCredsApi {
    ...
    async registerCredentialDefinition(options) {
        ...
        try {
            ...
            const { credentialDefinition, credentialDefinitionPrivate, keyCorrectnessProof } = await this.anonCredsIssuerService.createCredentialDefinition(this.agentContext, {
    ...
    async storeCredentialDefinitionRecord(result, credentialDefinitionPrivate, keyCorrectnessProof) {
        try {
    ...
    async storeSchemaRecord(result) {
        try {
