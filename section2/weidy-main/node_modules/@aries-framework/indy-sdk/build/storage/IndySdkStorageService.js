...
let IndySdkStorageService = IndySdkStorageService_1 = class IndySdkStorageService {
    constructor(indySdk) {
    ...
    async getById(agentContext, recordClass, id) {
        (0, assertIndySdkWallet_1.assertIndySdkWallet)(agentContext.wallet);
        try {
            const record = await this.indySdk.getWalletRecord(agentContext.wallet.handle, recordClass.type, id, IndySdkStorageService_1.DEFAULT_QUERY_OPTIONS);
    ...
    async getAll(agentContext, recordClass) {
        var _a, e_1, _b, _c;
        (0, assertIndySdkWallet_1.assertIndySdkWallet)(agentContext.wallet);
        const recordIterator = this.search(agentContext.wallet, recordClass.type, {}, IndySdkStorageService_1.DEFAULT_QUERY_OPTIONS);
        const records = [];
        try {
    ...
    async findByQuery(agentContext, recordClass, query) {
        ...
        const recordIterator = this.search(agentContext.wallet, recordClass.type, indyQuery, IndySdkStorageService_1.DEFAULT_QUERY_OPTIONS);
        const records = [];
        try {
...
IndySdkStorageService = IndySdkStorageService_1 = __decorate([
    (0, core_1.injectable)(),
...
//# sourceMappingURL=IndySdkStorageService.js.map