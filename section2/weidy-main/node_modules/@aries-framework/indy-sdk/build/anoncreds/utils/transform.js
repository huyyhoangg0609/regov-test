...
function anonCredsCredentialDefinitionFromIndySdk(credentialDefinition) {
    const issuerId = (0, identifiers_1.didFromCredentialDefinitionId)(credentialDefinition.id);
    return {
        issuerId,
...
function anonCredsRevocationRegistryDefinitionFromIndySdk(revocationRegistryDefinition) {
    const issuerId = (0, identifiers_1.didFromRevocationRegistryDefinitionId)(revocationRegistryDefinition.id);
    return {
        issuerId,
...
exports.anonCredsRevocationRegistryDefinitionFromIndySdk = anonCredsRevocationRegistryDefinitionFromIndySdk;
