...
let IndySdkRevocationService = class IndySdkRevocationService {
     ...
     */
    async createRevocationState(agentContext, proofRequest, requestedCredentials, revocationRegistries) {
        var _a, _b;
        try {
            ...
            for (const [referent, requestedCredential] of Object.entries((_a = requestedCredentials.requestedAttributes) !== null && _a !== void 0 ? _a : {})) {
            ...
            for (const [referent, requestedCredential] of Object.entries((_b = requestedCredentials.requestedPredicates) !== null && _b !== void 0 ? _b : {})) {
                referentCredentials.push({
                    referent,
                    credentialInfo: requestedCredential.credentialInfo,
