...
class IndyCredentialFormatService {
     ...
     *
     */
    async createProposal(agentContext, { credentialFormats, credentialRecord, attachmentId }) {
    ...
    async acceptOffer(agentContext, { credentialFormats, credentialRecord, attachmentId, offerAttachment, }) {
        var _a;
        const indyFormat = credentialFormats === null || credentialFormats === void 0 ? void 0 : credentialFormats.indy;
