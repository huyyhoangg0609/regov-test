...
let W3cCredentialService = class W3cCredentialService {
     ...
     */
    async verifyCredential(agentContext, options, verifyRevocationState = true) {
        ...
        const verifyOptions = {
            ...
            checkStatus: () => {
                if (verifyRevocationState) {
                    throw new error_1.AriesFrameworkError('Revocation for W3C credentials is currently not supported');
                }
                return {
                    verified: true,
                };
