...
class ProofAttributeInfo {
    constructor(options) {
        ...
        if (options) {
            ...
            this.nonRevoked = options.nonRevoked ? new credentials_1.IndyRevocationInterval(options.nonRevoked) : undefined;
            this.restrictions = (_a = options.restrictions) === null || _a === void 0 ? void 0 : _a.map((r) => new AttributeFilter_1.AttributeFilter(r));
        }
    }
}
__decorate([
...
//# sourceMappingURL=ProofAttributeInfo.js.map