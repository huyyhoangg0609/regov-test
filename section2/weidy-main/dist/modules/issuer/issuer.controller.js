...
const credentialBody_dto_1 = require("./dto/credentialBody.dto");
...
__decorate([
    (0, common_1.Post)('/schema/create'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [schemaInput_dto_1.SchemaInput]),
    __metadata("design:returntype", Promise)
], IssuerController.prototype, "createSchema", null);
__decorate([
    (0, common_1.Post)('/credential/offer'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Query)('cred-def-id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [credentialBody_dto_1.CredentialBody, String]),
    __metadata("design:returntype", Promise)
